...
const PUBLISHER_NAME_TYPE = {
  ...
  // ── 방송/통신 ──
  '연합뉴스':'방송/통신','뉴시스':'방송/통신','뉴스1':'방송/통신','KBS':'방송/통신','MBC':'방송/통신',
  'SBS':'방송/통신','YTN':'방송/통신','MBN':'방송/통신','JTBC':'방송/통신','연합뉴스TV':'방송/통신',
  '한국경제TV':'방송/통신','서울경제TV':'방송/통신','팍스경제TV':'방송/통신','SEN서울경제TV':'방송/통신',
  // ── 경제/IT ──
  '매일경제':'경제/IT','한국경제':'경제/IT','이데일리':'경제/IT','머니투데이':'경제/IT','서울경제':'경제/IT',
  '파이낸셜뉴스':'경제/IT','아시아경제':'경제/IT','아주경제':'경제/IT','헤럴드경제':'경제/IT','조선비즈':'경제/IT',
  '이투데이':'경제/IT','뉴스핌':'경제/IT','비즈니스포스트':'경제/IT','대한경제':'경제/IT','전자신문':'경제/IT',
  '디지털타임스':'경제/IT','디지털데일리':'경제/IT','아이뉴스24':'경제/IT','ZDNet코리아':'경제/IT','블로터':'경제/IT',
  '더벨':'경제/IT','딜사이트':'경제/IT','서울파이낸스':'경제/IT','브릿지경제':'경제/IT','한스경제':'경제/IT',
  '파이노미':'경제/IT','에너지경제':'경제/IT','EBN산업뉴스':'경제/IT','비즈니스플러스':'경제/IT','메가이코노미':'경제/IT',
  '시장경제':'경제/IT','마켓인사이트':'경제/IT','더밸류뉴스':'경제/IT','스마트경제':'경제/IT','초이스경제':'경제/IT',
  '이코노뉴스':'경제/IT','이코노미스트':'경제/IT','한국금융신문':'경제/IT','파이낸셜포스트':'경제/IT','스마트에프엔':'경제/IT',
  '중기이코노미':'경제/IT','서울이코노미뉴스':'경제/IT','더비즈':'경제/IT','아이투자':'경제/IT','FETV':'경제/IT',
  '세계비즈':'경제/IT','머니S':'경제/IT','한스경제':'경제/IT','더트래커':'경제/IT','비즈월드':'경제/IT',
  '토큰포스트':'경제/IT','글로벌이코노믹':'경제/IT','포춘코리아':'매거진/전문지','굿모닝경제':'경제/IT',
  '한국정경신문':'경제/IT','시사저널이코노미':'경제/IT','빅데이터뉴스':'경제/IT',
  // ── 인터넷신문 ──
  ...
  '바이오타임즈':'매거진/전문지','에너지신문':'매거진/전문지','한국건설신문':'매거진/전문지','디지털투데이':'경제/IT',
  // ── 지역지 ──
  '매일신문':'지역지','부산일보':'지역지','국제신문':'지역지','경기일보':'지역지','충북일보':'지역지',
  // ── 스포츠/연예 ──
