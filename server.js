...
const PUBLISHER_NAME_TYPE = {
  // ── 종합일간지 ──
  '조선일보':'종합일간지','중앙일보':'종합일간지','동아일보':'종합일간지','한겨레':'종합일간지',
  '경향신문':'종합일간지','서울신문':'종합일간지','국민일보':'종합일간지','문화일보':'종합일간지',
  '한국일보':'종합일간지','세계일보':'종합일간지','내일신문':'종합일간지',
  // ── 방송/통신 ──
  '이데일리TV':'방송/통신','뉴스1코리아':'방송/통신','뉴스핌TV':'방송/통신','뉴스원':'방송/통신',
  'NSP통신':'방송/통신','연합뉴스':'방송/통신','뉴시스':'방송/통신','뉴스1':'방송/통신',
  'KBS':'방송/통신','MBC':'방송/통신','SBS':'방송/통신','YTN':'방송/통신',
  'MBN':'방송/통신','JTBC':'방송/통신','연합뉴스TV':'방송/통신','한국경제TV':'방송/통신',
  '서울경제TV':'방송/통신','팍스경제TV':'방송/통신','SEN서울경제TV':'방송/통신',
  // ── 경제/IT ──
  '뉴스핌':'경제/IT','IT조선':'경제/IT','디지털비즈온':'경제/IT','데일리비즈온':'경제/IT',
  '글로벌이코노믹':'경제/IT','데일리안경제':'경제/IT','이코노믹데일리':'경제/IT','전자경제':'경제/IT',
  '이코노미조선':'경제/IT','팜스탁':'경제/IT','글로벌경제신문':'경제/IT','매경이코노미':'경제/IT',
  '데일리이코노미':'경제/IT','데일리시큐':'경제/IT','프라임경제':'경제/IT','시장경제신문':'경제/IT',
  'CEO스코어데일리':'경제/IT','글로벌비즈':'경제/IT','씨이오데일리':'경제/IT','매일경제':'경제/IT',
  '한국경제':'경제/IT','이데일리':'경제/IT','머니투데이':'경제/IT','서울경제':'경제/IT',
  '파이낸셜뉴스':'경제/IT','아시아경제':'경제/IT','아주경제':'경제/IT','헤럴드경제':'경제/IT',
  '조선비즈':'경제/IT','이투데이':'경제/IT','비즈니스포스트':'경제/IT','대한경제':'경제/IT',
  '전자신문':'경제/IT','디지털타임스':'경제/IT','디지털데일리':'경제/IT','아이뉴스24':'경제/IT',
  'ZDNet코리아':'경제/IT','블로터':'경제/IT','더벨':'경제/IT','딜사이트':'경제/IT',
  '서울파이낸스':'경제/IT','브릿지경제':'경제/IT','한스경제':'경제/IT','파이노미':'경제/IT',
  '에너지경제':'경제/IT','EBN산업뉴스':'경제/IT','비즈니스플러스':'경제/IT','메가이코노미':'경제/IT',
  '시장경제':'경제/IT','마켓인사이트':'경제/IT','더밸류뉴스':'경제/IT','스마트경제':'경제/IT',
  '초이스경제':'경제/IT','이코노뉴스':'경제/IT','이코노미스트':'경제/IT','한국금융신문':'경제/IT',
  '파이낸셜포스트':'경제/IT','스마트에프엔':'경제/IT','중기이코노미':'경제/IT','서울이코노미뉴스':'경제/IT',
  '더비즈':'경제/IT','아이투자':'경제/IT','FETV':'경제/IT','세계비즈':'경제/IT',
  '머니S':'경제/IT','더트래커':'경제/IT','비즈월드':'경제/IT','토큰포스트':'경제/IT',
  '굿모닝경제':'경제/IT','한국정경신문':'경제/IT','시사저널이코노미':'경제/IT','빅데이터뉴스':'경제/IT',
  '디지털투데이':'경제/IT','아이러브피씨':'경제/IT','이코노믹리뷰':'경제/IT',
  // ── 인터넷신문 ──
  '아시아투데이':'인터넷신문','데일리그리드':'인터넷신문','메트로경제':'인터넷신문','뉴스벨':'인터넷신문',
  '피엘뉴스':'인터넷신문','이뉴스코리아':'인터넷신문','더팩트':'인터넷신문','비즈팩트':'인터넷신문',
  'CNB뉴스':'인터넷신문','스카이데일리':'인터넷신문','뉴데일리':'인터넷신문','뉴스클레임':'인터넷신문',
  '메트로신문':'인터넷신문','컨슈머타임스':'인터넷신문','소비자경제':'인터넷신문','시빅뉴스':'인터넷신문',
  '화이트페이퍼':'인터넷신문','소셜포커스':'인터넷신문','비즈한국':'인터넷신문','바끄로':'인터넷신문',
  '핀포인트뉴스':'인터넷신문','캐치뉴스':'인터넷신문','더퍼스트미디어':'인터넷신문','스마트타임즈':'인터넷신문',
  '글로벌에픽':'인터넷신문','비즈트리뷴':'인터넷신문','뉴스드림':'인터넷신문','청년일보':'인터넷신문',
  '더뷰어스':'인터넷신문','데일리팝':'인터넷신문','데일리안':'인터넷신문','뉴스투데이':'인터넷신문',
  '서울와이어':'인터넷신문','뉴스웍스':'인터넷신문','MS투데이':'인터넷신문','위클리':'인터넷신문',
  '이뉴스투데이':'인터넷신문','시사캐스트':'인터넷신문','와이드데일리':'인터넷신문','비즈니스코리아':'인터넷신문',
  '뉴스로드':'인터넷신문','신아일보':'인터넷신문','중앙경제뉴스':'인터넷신문','시대일보':'인터넷신문',
  '뉴스포스트':'인터넷신문','녹색경제':'인터넷신문','뉴스프라임':'인터넷신문','포인트데일리':'인터넷신문',
  '데일리한국':'인터넷신문','인사이트코리아':'인터넷신문','뉴시안':'인터넷신문','소셜밸류':'인터넷신문',
  'HBN뉴스':'인터넷신문','라이브스뉴스':'인터넷신문','탑데일리':'인터넷신문','아시아타임':'인터넷신문',
  '미디어펜':'인터넷신문','프레스맨':'인터넷신문','뉴스퀘스트':'인터넷신문','스타트업투데이':'인터넷신문',
  '뉴스웨이':'인터넷신문','뉴스토마토':'인터넷신문','노컷뉴스':'인터넷신문','오마이뉴스':'인터넷신문',
  '데이터솜':'인터넷신문','시사오늘':'인터넷신문','인사이트':'인터넷신문','법률이슈':'인터넷신문',
  '뉴스워커':'인터넷신문','직썰':'인터넷신문','시사저널':'인터넷신문','더구루':'인터넷신문',
  '프레스나인':'인터넷신문','위키트리':'인터넷신문','허프포스트':'인터넷신문','우먼타임스':'인터넷신문',
  '월요신문':'인터넷신문','비욘드포스트':'인터넷신문','뉴스프리존':'인터넷신문','스마트투데이':'인터넷신문',
  '천지일보':'인터넷신문','잡포스트':'인터넷신문','팝콘뉴스':'인터넷신문','스트레이트뉴스':'인터넷신문',
  '고코리아':'인터넷신문','위민경제':'인터넷신문','퍼블릭뉴스':'인터넷신문','빅타임즈':'인터넷신문',
  '이슈앤비즈':'인터넷신문','이넷뉴스':'인터넷신문','아시아에이':'인터넷신문','인사이드비나':'인터넷신문',
  'CS타임즈':'인터넷신문','마켓경제':'인터넷신문','국제뉴스':'인터넷신문','로컬세계':'인터넷신문',
  '그린포스트코리아':'인터넷신문',
  // ── 매거진/전문지 ──
  '월간중앙':'매거진/전문지','메디게이트뉴스':'매거진/전문지','팜뉴스':'매거진/전문지','메디컬옵저버':'매거진/전문지',
  '헬스조선':'매거진/전문지','뷰티누리':'매거진/전문지','코스모닝':'매거진/전문지','장업신문':'매거진/전문지',
  'CMN':'매거진/전문지','피알타임스':'매거진/전문지','라포르시안':'매거진/전문지','데일리메디':'매거진/전문지',
  '아웃소싱타임스':'매거진/전문지','CNC뉴스':'매거진/전문지','FA저널':'매거진/전문지','포브스코리아':'매거진/전문지',
  '포춘코리아':'매거진/전문지','뷰티경제':'매거진/전문지','보건뉴스':'매거진/전문지','한국섬유신문':'매거진/전문지',
  '한국면세뉴스':'매거진/전문지','약업신문':'매거진/전문지','어패럴뉴스':'매거진/전문지','헬스경향':'매거진/전문지',
  '메디컬투데이':'매거진/전문지','메디파나뉴스':'매거진/전문지','히트뉴스':'매거진/전문지','패션비즈':'매거진/전문지',
  '메디칼업저버':'매거진/전문지','매경헬스':'매거진/전문지','키즈맘':'매거진/전문지','베이비뉴스':'매거진/전문지',
  '패션인사이트':'매거진/전문지','바이오타임즈':'매거진/전문지','에너지신문':'매거진/전문지','한국건설신문':'매거진/전문지',
  // ── 지역지 ──
  '중부일보':'지역지','경인일보':'지역지','강원일보':'지역지','대전일보':'지역지',
  '광주일보':'지역지','충청타임즈':'지역지','매일신문':'지역지','부산일보':'지역지',
  '국제신문':'지역지','경기일보':'지역지','충북일보':'지역지',
  // ── 스포츠/연예 ──
  '스포츠월드':'스포츠/연예','스포츠투데이':'스포츠/연예','스포탈코리아':'스포츠/연예','스포츠경향':'스포츠/연예',
  '디스패치':'스포츠/연예','스포츠동아':'스포츠/연예','마이데일리':'스포츠/연예','톱스타뉴스':'스포츠/연예',
  '스포츠서울':'스포츠/연예','일간스포츠':'스포츠/연예',
};
