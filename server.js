...
const PUBLISHER_NAME_TYPE = {
  // ── 2차 미매핑 추가 ──
  '글로벌경제신문':'경제/IT','비즈팩트':'인터넷신문','스포츠경향':'스포츠/연예','CNB뉴스':'인터넷신문',
  '스카이데일리':'인터넷신문','뉴데일리':'인터넷신문','피알타임스':'매거진/전문지','라포르시안':'매거진/전문지',
  '데일리메디':'매거진/전문지','뉴스클레임':'인터넷신문','메트로신문':'인터넷신문','아웃소싱타임스':'매거진/전문지',
  '컨슈머타임스':'인터넷신문','CNC뉴스':'매거진/전문지','FA저널':'매거진/전문지','매경이코노미':'경제/IT',
  '소비자경제':'인터넷신문','디스패치':'스포츠/연예','데일리이코노미':'경제/IT','데일리시큐':'경제/IT',
  '프라임경제':'경제/IT','NSP통신':'방송/통신','시빅뉴스':'인터넷신문','포브스코리아':'매거진/전문지',
  '스포츠동아':'스포츠/연예','화이트페이퍼':'인터넷신문','소셜포커스':'인터넷신문','시장경제신문':'경제/IT',
  '비즈한국':'인터넷신문','CEO스코어데일리':'경제/IT','글로벌비즈':'경제/IT','바끄로':'인터넷신문',
  '씨이오데일리':'경제/IT',
  // ── 종합일간지 ──
  ...
  '헤럴드경제':'경제/IT','조선비즈':'경제/IT','이투데이':'경제/IT','뉴스핌':'경제/IT',
  '비즈니스포스트':'경제/IT','대한경제':'경제/IT','전자신문':'경제/IT','디지털타임스':'경제/IT',
  '디지털데일리':'경제/IT','아이뉴스24':'경제/IT','ZDNet코리아':'경제/IT','블로터':'경제/IT',
  '더벨':'경제/IT','딜사이트':'경제/IT','서울파이낸스':'경제/IT','브릿지경제':'경제/IT',
  '한스경제':'경제/IT','파이노미':'경제/IT','에너지경제':'경제/IT','EBN산업뉴스':'경제/IT',
  '비즈니스플러스':'경제/IT','메가이코노미':'경제/IT','시장경제':'경제/IT','마켓인사이트':'경제/IT',
  '더밸류뉴스':'경제/IT','스마트경제':'경제/IT','초이스경제':'경제/IT','이코노뉴스':'경제/IT',
  '이코노미스트':'경제/IT','한국금융신문':'경제/IT','파이낸셜포스트':'경제/IT','스마트에프엔':'경제/IT',
  '중기이코노미':'경제/IT','서울이코노미뉴스':'경제/IT','더비즈':'경제/IT','아이투자':'경제/IT',
  'FETV':'경제/IT','세계비즈':'경제/IT','머니S':'경제/IT','더트래커':'경제/IT',
  '비즈월드':'경제/IT','토큰포스트':'경제/IT','글로벌이코노믹':'경제/IT','굿모닝경제':'경제/IT',
  '한국정경신문':'경제/IT','시사저널이코노미':'경제/IT','빅데이터뉴스':'경제/IT','디지털투데이':'경제/IT',
  '아이러브피씨':'경제/IT','이코노믹리뷰':'경제/IT',
  // ── 인터넷신문 ──
  ...
  '아시아투데이':'인터넷신문','뉴스워커':'인터넷신문','직썰':'인터넷신문','시사저널':'인터넷신문',
  '더구루':'인터넷신문','프레스나인':'인터넷신문','위키트리':'인터넷신문','허프포스트':'인터넷신문',
  '우먼타임스':'인터넷신문','월요신문':'인터넷신문','비욘드포스트':'인터넷신문','뉴스프리존':'인터넷신문',
  '스마트투데이':'인터넷신문','천지일보':'인터넷신문','잡포스트':'인터넷신문','팝콘뉴스':'인터넷신문',
  '스트레이트뉴스':'인터넷신문','고코리아':'인터넷신문','위민경제':'인터넷신문','퍼블릭뉴스':'인터넷신문',
  '빅타임즈':'인터넷신문','이슈앤비즈':'인터넷신문','이넷뉴스':'인터넷신문','아시아에이':'인터넷신문',
  '인사이드비나':'인터넷신문','CS타임즈':'인터넷신문','마켓경제':'인터넷신문','국제뉴스':'인터넷신문',
  '로컬세계':'인터넷신문','그린포스트코리아':'인터넷신문',
  // ── 매거진/전문지 ──
  ...
  // ── 지역지 ──
  '충청타임즈':'지역지','매일신문':'지역지','부산일보':'지역지','국제신문':'지역지',
  '경기일보':'지역지','충북일보':'지역지',
  // ── 스포츠/연예 ──
  '마이데일리':'스포츠/연예','톱스타뉴스':'스포츠/연예','스포츠서울':'스포츠/연예','일간스포츠':'스포츠/연예',
};
